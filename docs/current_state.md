...
| Current operational cursor | 0.1.6 post-review Web corrections implemented, fully validated, and served by the private `trainlog.perf` service from development commit `713238f`; immutable stable v0.1.5 remains unchanged. |

...
Android local SQLite schema v24 retains the exactly-one durable active-session
...
desktop migrations reach v26 and Android migrations reach v24 without changing
...
The current desktop schema is v26. Schema v9 added an occurrence-owned explicit
...
and durable preparation withdrawal; v25 adds Programs; and v26 additively adds
logical Program deletion. None changes `TRAINLOG_FORMAT_V1`.
